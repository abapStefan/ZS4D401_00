...
CLASS lcl_bus DEFINITION INHERITING FROM lcl_fahrzeuge.
  ...
  PUBLIC SECTION.
    ...
    METHODS constructor          " neuen constructor für unterklasse Bus mit neuem Attribut
      IMPORTING i_hersteller TYPE string
                i_typ        TYPE string
                i_ps         TYPE i
                i_sitze      TYPE i.
...
* Option 2: Die Neudefinition verwendet den Aufruf der Implentierung der Oberklasse
