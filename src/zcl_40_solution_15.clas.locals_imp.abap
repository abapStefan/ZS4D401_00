...
CLASS lcl_passenger_flight DEFINITION .
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      BEGIN OF st_connection_details,                                          " Übung 05 / 1 Struktur kopieren nach Privat
...
*        distance_unit   TYPE msehi,
    ...
    CLASS-DATA connections_buffer TYPE TABLE OF st_connections_buffer.         " Aufgabe 5 / 2
...
*         ENDLOOP.
  ...
  IF NOT line_exists( flights_buffer[ carrier_id = i_carrier_id ] ).      " Aufgabe 14 / 4 IF Anweisung
...
*      INTO TABLE @flights_buffer.                                            " Aufgabe 4 / 1 Änderung
    ...
    SORT flights_buffer BY carrier_id connection_id flight_date.              " Aufgabe 14 / 3 später wieder kommentieren
...
*           TO r_result.
  ...
  APPEND txt TO r_result.
    ...
    APPEND |{ 'Duration:'(011) }       { connection_details-duration } { 'minutes'(012) } | TO r_result.             " Übung 7 Aufgabe 2
...
* Richtig
    DATA carrier_id    TYPE /dmo/carrier_id       READ-ONLY.                      " Jetzt richtige Zuweisung
    DATA connection_id TYPE /dmo/connection_id    READ-ONLY.                      " Jetzt richtige Zuweisung
    DATA flight_date   TYPE /dmo/flight_date      READ-ONLY.
...
CLASS lcl_carrier DEFINITION .
  ...
  PUBLIC SECTION.
    ...
    TYPES t_output TYPE string.                                  " Aufgabe 6 string
...
*    name = carrier_id && ` ` && name.                                           " Übung 11 / 5
  ...
  METHOD get_output.                                                          "Ab hier  Übung 8
